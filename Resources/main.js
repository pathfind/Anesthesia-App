...
if (!f.exists() ) {
	...
	message:'Download content or use packaged content?',
	buttonNames: ['Download','Packaged']
    });
...
http1 = function(url, params, xhrTimeout, callback, errorcallback) {
    ...
    xhr.send();
	  ...
	  http1('http://strykerappmanagement.com/dump.php?appid=1', null, 20000, function(response, responseText) {
...
var lblTitle = Ti.UI.createLabel({
    text: "9100-001-434 Rev None",
    textAlign: 'center',
    color: "white",
    width: 446,
    height: 66,
    backgroundColor: '#59536F',
});
imgBox.add(lblTitle);
