...
//@interface StrykerAnesthesiaObject : NSObject
//@end

@interface StrykerAnesthesiaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StrykerAnesthesiaObject class]])
		{
			for (NSString *key in [[(StrykerAnesthesiaObject*)o modules] allKeys])
			{
