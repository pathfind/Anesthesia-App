...
// in simulator we redefine to format for StrykerAnesthesia Developer console
...
{\
	NSString * exceptionName = [@"org.strykeranesthesia." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.strykeranesthesia";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIStrykerAnesthesiaNativeItemNone = -1, 
	UIStrykerAnesthesiaNativeItemSpinner = -2,
	UIStrykerAnesthesiaNativeItemProgressBar = -3,
	
	UIStrykerAnesthesiaNativeItemSlider = -4,
	UIStrykerAnesthesiaNativeItemSwitch = -5,
	UIStrykerAnesthesiaNativeItemMultiButton = -6,
	UIStrykerAnesthesiaNativeItemSegmented = -7,
	
	UIStrykerAnesthesiaNativeItemTextView = -8,
	UIStrykerAnesthesiaNativeItemTextField = -9,
	UIStrykerAnesthesiaNativeItemSearchBar = -10,
	
	UIStrykerAnesthesiaNativeItemPicker = -11,
	UIStrykerAnesthesiaNativeItemDatePicker = -12,
	
	UIStrykerAnesthesiaNativeItemInfoLight = -13,
	UIStrykerAnesthesiaNativeItemInfoDark = -14,
	
	UIStrykerAnesthesiaNativeItemDisclosure = -15,
	
	UIStrykerAnesthesiaNativeItemContactAdd = -16
};
